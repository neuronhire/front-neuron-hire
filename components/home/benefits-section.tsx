    ...
    <section className="py-24 px-6 text-center bg-white">
      <div className="max-w-6xl mx-auto">
        <div className="max-w-3xl mx-auto mb-12">
          <p className="text-neutral-600 max-w-2xl mx-auto text-sm font-medium mb-1">
            A RADICALLY DIFFERENT WAY TO HIRE
          </p>
          <h2 className="text-5xl font-bold text-neutral-900 mb-5">
            Built from the ground up for speed, quality, and control.
          </h2>
          <p className="text-neutral-600 max-w-3xl mx-auto text-lg font-medium">
