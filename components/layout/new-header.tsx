    ...
    columns: [
      {
        title: "Column 1",
        items: [
          { title: "Item 1", href: "/for-developers" },
          { title: "Item 2", href: "/for-developers" },
        ],
      },
      {
        title: "Column 2",
        items: [
          { title: "Item 3", href: "/for-developers" },
          { title: "Item 4", href: "/for-developers" },
        ],
      },
    ],
  },
      ...
      return (
        <NavigationMenuItem key={`${section.title}-${idx}`}>
          <NavigationMenuLink asChild>
            <Link
              href={section.href}
              className="body-satoshi text-neuronhire-black-100 text-base font-medium px-2 py-2 rounded-md hover:underline"
            >
              {section.title}
            </Link>
          </NavigationMenuLink>
    ...
    if (!hasSubmenu && section.href) {
      return (
        <Link
          ...
          href={section.href}
          className="flex items-center w-full px-6 py-4 text-left hover:underline"
